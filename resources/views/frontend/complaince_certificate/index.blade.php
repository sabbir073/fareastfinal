              ...
              <div class="row">
                  <div class="col-md-12">
                      <div class="breadcrumb_wrapper d-flex flex-column align-items-center">
                          <h4 class="page_title text-uppercase" style="margin-top: 35px;">Complaince Certificate</h4>
                      </div>
                  </div>
              </div><!-- ends: .row -->
          </div>
            ...
            <tbody>
              ...
              @foreach ($reports as $report)
                <tr>
                    ...
                    <td><i class="fa fa-download" style="color: #B22A08; margin-right:5px;"></i><a href="{{ route('complaince_certificate_download',$report->id) }}" download>Download</a></td>
                  </tr>

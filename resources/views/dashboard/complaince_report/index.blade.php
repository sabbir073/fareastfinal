                 ...
                 <!-- Large modal -->
                  ...
                  <div class="modal fade bd-example-modal-lg"tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" style="width: 100% !important;" >
                      ...
                      <form action="{{ route('complaince_report_create') }}" method="post" style="padding: 6.5rem;" enctype="multipart/form-data">
                        @csrf
  											...
  											<div class="row no-gutters">
  												...
  												<label for="">Add Title:</label>
  													<input class="form-control" type="text" name="desc" placeholder="Add Title">
  												</div>
                              ...
                              <tr>
                                  ...
                                  <a href="{{ route('complaince_certificate_download',$all_report->id) }}" target="_parent" class="btn btn-primary">
                                    Download Pdf
                                        ...
                                        <a type="button" href="{{ url("/dashboard/complaince/report/edit") }}/{{ $all_report->id }}" class="btn btn-secondary pd-x-25 active"><i class="icon ion-edit"></i></a>
                                        <a type="button" href="{{ url('/dashboard/complaince/report/delete/') }}/{{ $all_report->id }}" class="btn btn-danger pd-x-25"><i class="icon ion-trash-a"></i></a>
                                  </div>
              									</td>
              								</tr>

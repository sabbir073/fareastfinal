...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      <form action="{{ route('complaince_report_update',$each_reports->id) }}" method="post" style="padding: 6.5rem;" enctype="multipart/form-data">
                        @csrf
  											...
  											<div class="row no-gutters">
  												...
  												<label for="">Edit Title:</label>
  													<input class="form-control" type="text" value="{{$each_reports->desc}}" name="desc" placeholder="Add Title">
  												</div>
